...
*EmailApi* | [**GetEmailAttachmentAsync**](EmailApi.md#getemailattachmentasync) | **GET** /email/{fileName}/attachments | Get email attachment by name. Not available on .NETFramework v2.0
