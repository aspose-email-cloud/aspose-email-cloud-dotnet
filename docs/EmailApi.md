...
```csharp
ListResponseOfHierarchicalObject AiBcrParseOcrData(AiBcrParseOcrDataRequest request)
```
...
<a name="aibcrparseocrdata"></a>
# **AiBcrParseOcrDataAsync**

```csharp
async Task<ListResponseOfHierarchicalObject> AiBcrParseOcrDataAsync(AiBcrParseOcrDataRequest request)
```
...
```csharp
ListResponseOfStorageFileLocation AiBcrParseOcrDataStorage(AiBcrParseOcrDataStorageRequest request)
```
...
<a name="aibcrparseocrdatastorage"></a>
# **AiBcrParseOcrDataStorageAsync**

```csharp
async Task<ListResponseOfStorageFileLocation> AiBcrParseOcrDataStorageAsync(AiBcrParseOcrDataStorageRequest request)
```
