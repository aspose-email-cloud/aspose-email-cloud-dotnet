...
```csharp
async Task<ListFoldersResponse> ListEmailFoldersAsync(ListEmailFoldersRequest request)
```
...
Task<[**ListFoldersResponse**](ListFoldersResponse.md)>
...
```csharp
async Task<ListMessagesResponse> ListEmailMessagesAsync(ListEmailMessagesRequest request)
```
...
Task<[**ListMessagesResponse**](ListMessagesResponse.md)>
